...
public class TimeTableTest {
	 ...
	 @Test
	  public void testGetApptRange()  throws Throwable  {
		 ...
		 assertEquals(1, c.size());//found bug here
		 int count = 0;
		 ...
		 assertEquals(1, count);//found bug here

		 assertEquals(30, c2.size());
		 count = 0;
	...
	public void testGetNextApptOccurrence()  throws Throwable  {
		...
		assertEquals(13, count);//found bug here
	...
	public void testApptOccurrences2()  throws Throwable  {
		...
		assertEquals(5, count);//found bug here
	}
	...
	public void testApptOccurrences4()  throws Throwable  {
		...
		assertEquals(3, count);//found bug here
	}
